...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name="OpModeTeleOp", group="Teleop")  // @MyAutonomous(...) is the other common choice
public class OpModeTeleOp extends OpMode
{
    ...
    double curPowerOfMotorSpinner = 0.61;
